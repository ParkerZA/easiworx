...
namespace Finx.App.UserControls
{
        ...
        public partial class Accordion : UserControl, IMessageFilter
        {
            ...
            public CheckBox Add(Control c, String text, String toolTip = null, double fillWt = 0, bool? open = null, Padding? contentPadding = null, Padding? contentMargin = null, Color? contentBackColor = null, Padding? checkboxMargin = null, bool? addResizeBar = null, Padding? resizeBarMargin = null, LayoutArgs layoutArgs = null,Image Image=null)
            {
            ...
            public CheckBox Add(AddArgs args)
            {
                ...
                CheckBox cb = cbf.CreateCheckBox(args.text, check, Get(checkboxMargin, CheckBoxMargin),args.Image);
                args.CheckBox = cb;
            ...
            {
                CheckBox CreateCheckBox(String text, bool check, Padding margin,Image image=null);
            }
            ...
            {
                public virtual CheckBox CreateCheckBox(String text, bool check, Padding margin,Image image=null)
                {
                    CheckBox cb = new CheckBox();
                    cb.Appearance = Appearance.Button;

                cb.FlatAppearance.BorderColor = Color.Gainsboro;
                ...
                {
                    cb.Image = image;
                    cb.ImageAlign = System.Drawing.ContentAlignment.MiddleLeft;
        ...
        public class ResizeBar : UserControl
        {
            ...
            public ResizeBar()
            {
                ...
                this.MinimumSize = new Size(0, 5); // doesn't render properly at smaller heights
                using (var g = Graphics.FromHwnd(IntPtr.Zero))
                {
                    float dpiY = g.DpiY;
                    this.Size = new Size(0, Math.Max(13, (int)(10 * dpiY / 120)));
                }

            VisualStyle = ResizeBarVisualStyle.ModernSubtle; // ClassicNone
...
//TrackBarRenderer.DrawHorizontalThumb(g, grip, state);
                            TrackBarRenderer.DrawVerticalThumb(g, grip, state);
                            DrawGrip(g, grip, -5);
                            }
                        }
                    }
