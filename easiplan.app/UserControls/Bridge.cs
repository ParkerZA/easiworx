...
namespace Finx.App.UserControls
{
    public static class Bridge
    {
        ...
        {
            get { return GdiHelpers.IconToAlphaBitmap(easiplan.app.Properties.Resources.finworks1); }
        }
        ...
        {   
            get { return GdiHelpers.IconToAlphaBitmap(SystemIcons.Information); }
        }

        public static string MachineKey
        {
            get { return null; }// Program.RegistryEntry.licDetails.MachineKey; }
        }

        public static void RegistrationEmail()
        {
           // MessageBox.Show(Program.RegistryEntry.licDetails.MachineKey);
        }
    }
