...
namespace Finx.App
{
    public partial class frmMetroClientCommunicationSms : MetroForm
    {
        ...
        /// </summary>
        public frmMetroClientCommunicationSms()
        {
            InitializeComponent();
            ...
            this.Text = "Manage Sms Templates";
            ...
            this.xToolBarMenu1.tbCaption.Text = string.Format("{0}", "Manage Sms Templates");// 
            ...
            xToolBarMenu1.tbRefresh.Visible = true; xToolBarMenu1.tbRefresh.Enabled = true; xToolBarMenu1.tbRefresh.Text = "Add new";
            xToolBarMenu1.RefreshClicked += toolStripButton_AddNew_Click; //toolStripButton_Preview_Click; ;
        ...
        public frmMetroClientCommunicationSms(IList<ClientDetails> model)
        {
            InitializeComponent();
            ...
            this.xToolBarMenu1.tbCaption.Text = string.Format("{0}", " Send Sms");
            this.xToolBarMenu1.tbCaptionImage.Image = Properties.Resources.mail_b_42;
        ...
        private void frmMetroClientCommunicationSms_Load(object sender, EventArgs e)
        {
            ...
            this.metroPanel_AdminTaskAdd.Initialise(currentEmailTemplate, cntr =>
            {
               ...
               // cntr.For(x => x.TemplateSubject, "Subject", new MetroTextBoxEditor(Width: this.Width - 50));
                cntr.For(x => x.TemplateBody, "Message", new MetroHtmlEditor(Width: this.Width - 50, Height: this.Height - 210, placeHolderType:typeof(ClientDetails)));
            ...
            try
            {
                if (currentEmailTemplate.Id > 0)
                {
                    if (MessageBoxExt.ShowQuestion("Are you sure to Delete this Template"))
                    {
                        ...
                        frmMetroClientCommunicationSms_Load(sender, e);
                    }
                }
        ...
        protected override void OnResize(EventArgs e)
        {
            ...
            if (TemplateBodyCntrl != null)
            {
                ...
                TemplateBodyCntrl.Height = this.Height - 210;
            }
