...
// Type: my.domain.lib.core.Encryption.DbEncrypt
...
namespace my.domain.lib.core.Encryption
{
    public class DbEncrypt
    {
                ...
                if (((IEnumerable<object>)property.GetCustomAttributes(typeof(EncryptAttribute), true)).Any<object>())
                {
                    ...
                    foreach (string propertyName in propertyNames)
                    {
                        if (string.Equals(propertyName, name, StringComparison.InvariantCultureIgnoreCase))
                        {
                            ...
                            {
                                string str2 = !Encrypt ? str1.Decrypt("key1") : str1.Encrypt("key1");
        ...
        public void DecryptProperties(object entity, string[] propertyNames, object[] state)
        {
